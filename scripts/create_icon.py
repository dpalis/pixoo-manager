...
# Colors
BG = (25, 25, 35)       # Dark background
C6 = (0, 212, 255)      # Cyan for "6"
C4 = (255, 92, 176)     # Pink/magenta for "4"
X = BG                   # Shorthand for background

# 8x8 pixel art design - "64" stylized for LED display
# "6" in cyan (left), "4" in pink (right)
PIXEL_ART = [
    # Row 0
    [C6, C6, C6, X,  X,  C4, C4, X ],
    # Row 1
    [C6, X,  X,  X,  C4, X,  C4, X ],
    # Row 2
    [C6, X,  X,  X,  C4, X,  C4, X ],
    # Row 3
    [C6, C6, C6, X,  C4, C4, C4, C4],
    # Row 4
    [C6, X,  C6, X,  X,  X,  C4, X ],
    # Row 5
    [C6, X,  C6, X,  X,  X,  C4, X ],
